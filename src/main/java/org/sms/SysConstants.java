...
public interface SysConstants {
  ...
  String IPDLOGIN_PAGE = "http://soaer.com/login.html";
  String PARAM_VALUE = "=";
  ...
  String BLOG_HTML_KEY = "blogHtml";
  String SYS_CONFIG = "config/sys/sysConfig.xml";
  String BLOG_TEMPLATE = "config/template/blog.html";
  String COMMENTS_TEMPLATE = "config/sys/auth.txt";
  String ES_CONF = "config/elasticsearch.properties";
  String MAIL_CONF = "config/mail.properties";
  String DOMAIN = "soaer.com";
  String ROLE_ADMAIN_NAME = "ADMIN";
  String FILE_ABS_PATH = "/home/sunny/soaer-files/";
  String USER_ID_KEY = "cid";
  String COMMENTS_NAME = "cName";
  String CIPHER_KEY = "mjjiidny";
}